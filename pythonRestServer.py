...
# but in order to make it work for real you will have to register a url of your own on wrike later
#  1. REGISTER your endpoint URL by doing the tutorial from https://developers.wrike.com/documentation/webhooks
...
class S(BaseHTTPRequestHandler):
    ...
    def do_GET(self):  # DEFINE WHAT YOU WANT TO DO IF THE USER SENDS A GET
        ...
        # test calling on browser localhost:8089/hahahahuhsaduh , localhost:8089/a, localhost:8089/,
        # localhost:8089/somepath and check what is printed
